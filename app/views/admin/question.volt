...
<div class="indexLeft">
    ...
    <div class="user-statistics">
    	<div class="stat-block" style="background-color:#00b354;">已解决：<a href="#">{{ resolvedCount }}</a></div>
    	<div class="stat-block" style="background-color:#0073dd;">待解答：<a href="#">{{ waitCount }}</a></div>
    	<div class="stat-block"  style="background-color:#b30000;">已关闭：<a href="#">{{ closeCount }}</a></div>
    </div>
